...
export const REQUEST_COPY = {
  ru: {
    ...
    waAfter: 'Написать в WhatsApp', waAfterHint: 'Можно не ждать: напишите сами, заявка уже у мастера.', waRequest: 'Заявка №',
  ...
  kz: {
    ...
    waAfter: 'WhatsApp-қа жазу', waAfterHint: 'Күтпей-ақ өзіңіз жаза аласыз: өтінім шеберде.', waRequest: '№',
