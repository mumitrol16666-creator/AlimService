import { BRANCHES, DEVICES, PROBLEMS, SOURCES } from '../data.js?v=202609201834';
import { store, newLead, isOpen, whatsappUrl, countWhatsAppSkip, BRANCH_WHATSAPP } from '../store.js?v=202609201834';
import { esc, ic, icons, shrinkImage } from '../ui.js?v=202609201834';
import { REQUEST_COPY, requestLang, saveRequestLang, modelLabel, modelValue, branchLabel, branchAddress } from '../request-copy.js?v=202609201834';
